...
## Constantes (Convenção em Python)

Em Python, não existe um tipo específico para constantes.  
Porém, por convenção, usamos **letras maiúsculas** para indicar que uma variável não deve ter seu valor alterado.

Essas variáveis são chamadas de **constantes por convenção**.
